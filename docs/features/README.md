...
| 05 | `05-frame-decoding.md` | WorkerによるI/Pフレームデコード | 顔認識の入力となる画像フレームを復元するため。 |
...
| 12 | `12-teacher-login.md` | 教員ログイン | 教員向け機能へのアクセス制御に必要なため。 |
| 13 | `13-teacher-account-management.md` | 管理者による教員アカウント追加 | 教員利用者を管理するため。 |
| 14 | `14-teacher-dashboard.md` | 教員ダッシュボード表示 | 蓄積済みデータを可視化する後段機能であるため。 |
